 ...
 *
 */
public class EncGyroPleaseBack extends Command {
    ...
    public EncGyroPleaseBack(double leftDist, double rightDist) {
    ...
    protected void execute() {
    	Robot.drivetrain.EncGyroBackward(leftDistance, rightDistance);
    }
